...
class Maps2 : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gpsRef = database.getReference("KeychainData/Bike Keychain/GPS")
        ...
        if (isLocationPermissionGranted()) {
            ...
            gpsRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    Log.d("Maps2Activity", "Latitude: $latitude, Longitude: $longitude")
